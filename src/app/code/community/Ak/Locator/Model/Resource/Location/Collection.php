...
class Ak_Locator_Model_Resource_Location_Collection extends Mage_Eav_Model_Entity_Collection_Abstract
{
    ...
    /**
     * Output this collection as a json object to be used by detect frontend
     *
     * @return mixed
     */
    public function toDetectJson()
    {
        $locations = array();
        $obj = new Varien_Object();
        $obj->setLocations($locations);
     ...
     * @return Varien_Object
     */
    public function getDetectResponseObject()
    {
        $obj = new Varien_Object();
        $obj->setLocations($this->toDetectJson());
