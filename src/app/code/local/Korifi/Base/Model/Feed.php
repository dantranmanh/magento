<?php
class Korifi_Base_Model_Feed extends Mage_AdminNotification_Model_Feed
{
    const XML_FREQUENCY_PATH    = 'kbase/feed/check_frequency';
    const XML_LAST_UPDATE_PATH  = 'kbase/feed/last_update';
    
    const URL_NEWS        = 'http://www.jetextension.com/feeds/news.xml';
    ...
    {
        return Mage::helper("kbase/promo")->isSubscribed();
    }
    ...
    public function checkUpdate()
    {
        ...
        if ($this->_isPromoSubscribed()) {
            ...
            $wasInstalled = gmdate('Y-m-d H:i:s', Korifi_Base_Helper_Module::baseModuleInstalled());
        ...
        Korifi_Base_Helper_Module::reload();
    ...
    {
        return Mage::app()->loadCache('kbase_notifications_lastcheck');
    }
 
    public function setLastUpdate()
    {
        Mage::app()->saveCache(time(), 'kbase_notifications_lastcheck');
        return $this;
    }
