...
class Mage_Shell_Compiler extends Mage_Shell_Abstract
{
    ...
    public function run()
    {
        $_product = Mage::getModel('catalog/product')->loadByAttribute('sku', 'SP-S6-EDGE-TP-GLASSdfdfd');
        if($_product){
            Mage::log('afterdfgfsg', Zend_Log::DEBUG, 'bi_debug2.log');
            Mage::log($_product->getData(), Zend_Log::DEBUG, 'bi_debug2.log');
        }
    ...
    function create_configurable_product($line_of_text,$supperattribute_code){
